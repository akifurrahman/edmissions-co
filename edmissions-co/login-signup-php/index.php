...
<head>
    ...
    <title>EDMISSIONS.APP - Log In</title>
        ...
        <div class="container-fluid">
            <div class="d-flex flex-row justify-content-center align-center">
                <div class="row">
                    ...
                    <div class="col login">
                        <div class="">
                            <form action="index.php" method="POST" autocomplete="">
                                <!-- <form action="index.php" class="needs-validation" method="POST" autocomplete="" novalidate> -->
                                ...
                                <div class="form-floating">
                                    ...
                                    <input name="email" type="email" class="form-control" id="floatingInput" required
                                        oninvalid="this.setCustomValidity('Please Enter a valid E-Mail')"
                                        oninput="setCustomValidity('')" placeholder="name@example.com" required
                                        value="<?php echo $email ?>">
                                </div>
                                <div class="form-floating mb-3">
                                    ...
                                    <input name="password" type="password" class="form-control" id="floatingPassword"
                                        ...
                                        oninput="setCustomValidity('')" placeholder="Password" required>
                    ...
                    if(count($errors) > 0){
                        ?>
                                <div style="color:rgb(234, 51, 65);" class="alert mt-2 mb-3 text-center ">
                                    <?php
                            foreach($errors as $showerror){
                                echo $showerror;
                            }
                    ...
                    ?>
                                ...
                                <button class="w-100 btn btn-lg button" name="login" value="login" type=" submit">Sign
                                    in</button>
                                <p class="m-3"><a class="sign-up" href="forgot-password.php">Forgot your Password?</a>
                                </p>
