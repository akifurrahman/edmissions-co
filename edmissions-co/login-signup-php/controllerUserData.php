...
if(isset($_POST['signup'])){
    ...
    if(count($errors) === 0){
        ...
        if($data_check){
            ...
            $mail->Body = "Dear $name,<br> Thank you for registering at EDMISSIONS.APP!<br>To complete your registration and access your account, please use the following one-time password (OTP): <b>$code</b>";
            //$mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
    ...
    if(isset($_POST['check-email'])){
        ...
        if(mysqli_num_rows($run_sql) > 0){
            ...
            //$mail->Body = "Hello $name!<br> Your verification code to create an EDMISSIONS.APP account is <b>$code</b>";
            $mail->Body = "Dear $name,<br> We've received a request to reset your password at EDMISSIONS.APP!<br>To set a new password for your account, please use the following one-time password (OTP): <b>$code</b>";
            //$mail->AltBody = 'This is the body in plain text for non-HTML mail clients';
