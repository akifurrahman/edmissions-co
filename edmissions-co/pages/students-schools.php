...
<body>
    ...
    <div class="mt-4 mb-4 preferences">
        ...
        <h1 class="w-75 m-auto font-weight-bold">Find Schools as a Student</h1>
    </div>
    ...
    <div class="wrapper">
        ...
        <iframe class="airtable-embed"
            src="https://airtable.com/embed/appxgKQrOtiLLlPQL/shrGCXV4tkMEElCjr/tblKdauAqQ9KAvmoV?backgroundColor=yellow&layout=card&viewControls=on"
            frameborder="0" onmousewheel="" width="100%" height="533"
            style="background: transparent; border: 1px solid #ccc;"></iframe>
        <div class="hidelogo">
