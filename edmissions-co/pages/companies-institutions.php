...
<head>
    ...
    <title>EDMISSIONS.APP - Find Institutions</title>
...
<body>
    ...
    <div class="mt-4 mb-4 preferences row">
        ...
        <div class="col-sm-2 mt-3 mb-3">
            <a href="companyloggedinindex.php" ; class="btn homebutton btn-warning"> <i class="fa fa-chevron-left"
                    aria-hidden="true"></i> Home</a>
        </div>
        <div class="col-sm-8 mt-3 mb-3">
            <h1 class="w-75 m-auto font-weight-bold">Find Institutions as a Company</h1>
        </div>
    </div>
    ...
    <!-- <iframe class="airtable-embed"
            src="
            https://airtable.com/embed/appwABQoF6JCdUZDL/shrKpKGezKWjvQ22D?backgroundColor=teal&layout=card&viewControls=on" frameborder="0"
            onmousewheel="" width="100%" height="533" style="background: transparent; border: 1px solid #ccc;"></iframe> -->

    <iframe class="airtable-embed" src="../pages/DDBs/companies-institutions/index.php" frameborder="0" onmousewheel=""
