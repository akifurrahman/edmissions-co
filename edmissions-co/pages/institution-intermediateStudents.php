...
<body>
    ...
    <div class="mt-4 mb-4 preferences row">
        ...
        <div class="col-sm-2 mt-3 mb-3">
            <a href="institutionloggedinindex.php" ; class="btn homebutton btn-warning"> <i class="fa fa-chevron-left"
                    aria-hidden="true"></i> Home</a>
        </div>
        <div class="col-sm-8 mt-3 mb-3">
            <h1 class="w-75 m-auto font-weight-bold">Find Intermediate Students as an Institution</h1>
        </div>
    </div>
    ...
    <div class="wrapper">
        ...
        <!-- <iframe class="airtable-embed"
            src="https://airtable.com/embed/appVYOKujkCygy2kH/shrg2I6Kf68gKhA5i?backgroundColor=red&layout=card&viewControls=on"
            frameborder="0" onmousewheel="" width="100%" height="533"
            style="background: transparent; border: 1px solid #ccc;"></iframe> -->

        <iframe class="airtable-embed"
            src="https://airtable.com/embed/appy8oCqTQVFOCWcp/shrMuYbNlYz7g1pEh/tblMRo13GE77ojFQI?backgroundColor=orange&layout=card&viewControls=on"
            frameborder="0" onmousewheel="" width="100%" height="533"
            style="background: transparent; border: 1px solid #ccc;"></iframe>
        <div class="hidelogo">
        </div>
