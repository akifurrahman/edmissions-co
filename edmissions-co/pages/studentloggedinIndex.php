...
<body>
    ...
    <div class="container-fluid mainbox p-0 m-4">
        <h5 class="mt-5 mb-4 mr-2 ml-2">Please Choose One Of The Options Below <i
        ...
        <div class="row flex-sm-col flex-md-row button-div">
            ...
            <!-- <div style="width:fit-content;" class="col-lg-3 col-md-4 col-sm-12"> -->
            <div class="col buttons" style="width:fit-content;">
                <!-- <a href="students-institutions.php"> -->
                <a href="studentsInstituteSubIndex.php">
