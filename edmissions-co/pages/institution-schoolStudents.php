...
<body>
    ...
    <div class="mt-4 mb-4 preferences row">
        ...
        <div class="col-sm-8 mt-3 mb-3">
            <h1 class="w-75 m-auto font-weight-bold">Find School Students as an Institution</h1>
        </div>
    </div>
    ...
    <div class="wrapper">
        ...
        <iframe class="airtable-embed"
            src="https://airtable.com/embed/app5ctU9ZEEZNq9zR/shri59X0Rp3f965EY?backgroundColor=gray&layout=card&viewControls=on"
            frameborder="0" onmousewheel="" width="100%" height="533"
            style="background: transparent; border: 1px solid #ccc;"></iframe>
        <div class="hidelogo">
        </div>
