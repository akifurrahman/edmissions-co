...
<body>
    ...
    <div class="mt-4 mb-4 preferences row">
        ...
        <div class="col-sm-8 mt-3 mb-3">
            <h1 class="w-75 m-auto font-weight-bold">Find Companies as a Student</h1>
        </div>
    </div>
    ...
    <iframe class="airtable-embed" src="../pages/DDBs/students-companies/index.php" frameborder="0" onmousewheel=""
