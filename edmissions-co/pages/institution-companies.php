...
<head>
    ...
    <title>EDMISSIONS.APP - Find Companies</title>
...
<body>
    ...
    <div class="mt-4 mb-4 preferences row">
        ...
        <div class="col-sm-8 mt-3 mb-3">
            <h1 class="w-75 m-auto font-weight-bold">Find Companies as an Institution</h1>
        </div>
    </div>

    <!-- <div class="wrapper"> -->
    <!-- <iframe class="airtable-embed"
            src="https://airtable.com/embed/app9Tdt451Om3JXOe/shr3M0B8F5TKO4U9D?backgroundColor=pink&layout=card&viewControls=on"
            frameborder="0" onmousewheel="" width="100%" height="533"
            style="background: transparent; border: 1px solid #ccc;"></iframe> -->

    <iframe class="airtable-embed" src="../pages/DDBs/institution-companies/index.php" frameborder="0" onmousewheel=""
