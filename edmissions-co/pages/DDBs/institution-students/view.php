    ...
    <div class="container my-4">
        ...
        <div class="container">
            ...
            <p><?//php echo $row["ID"]; ?></p> -->
                ...
                <div class="col-sm-6">
                    <div class=m-2>
                        <h3>Current Education Course:</h3>
                        <p><?php echo $row["Current_Education_Course"]; ?></p>
                    </div>
                ...
                <div class="col-sm-6">
                    <div class=m-2>
                        ...
                        <p><?php echo $row["Interested_Course"]; ?></p>
                    </div>
                ...
                <div class="col-sm-6">
                    <div class=m-2>
                        <h3>Local/Non Local:</h3>
                        <p><?php echo $row["Local_Non_Local"]; ?></p>
                    </div>
                ...
                <div class="col-sm-6">
                    <div class=m-2>
                        <h3>Family Income:</h3>
                        <p><?php echo $row["Family_Income"]; ?></p>
                    </div>
