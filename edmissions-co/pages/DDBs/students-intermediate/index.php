...
<head>
    <title>students-intermediate</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
...
<body>
    <main>
        ...
        $sqlSelect = "SELECT * FROM students_intermediate";
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <div class="box">
                                <!-- <p class="text-secondary fw-bold">E-Mail</p> -->
                                <?php echo $data['institution_type']; ?>
                            </div>
                        </td>
                        <td>
                            <div class="box">
                                <!-- <p class="text-secondary fw-bold">Contact</p> -->
                                <p class=""><?php echo $data['eligibility_criteria']; ?></p>
                        ...
                        <td>
                            <div class="box">
                                <!-- <p class="text-secondary fw-bold">E-Mail</p> -->
                                <?php echo $data['fee_details']; ?>
                            </div>
                        </td>
                        <td>
                            <div class="box">
                                <!-- <p class="text-secondary fw-bold">Contact</p> -->
                                <p class=""><?php echo $data['coaching_type']; ?></p>
