...
<head>
    <title>institution-companies</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
...
<body>
    <main>
            ...
            <table id="bstable"
                ...
                <thead class="align-middle">
                    <tr>
                        ...
                        <th>industry relevant opportunities</th>
                        <th>internships-coop-opportunities</th>
                        <th>job-placement-recruitment</th> -->
        ...
        $sqlSelect = "SELECT * FROM institution_companies";
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="box">
                                ...
                                <p class=""><?php echo $data['contact_number']; ?></p>
                        ...
                        <!-- <td>
                            <div class="box">
                                <p class=" fw-bold">
                                    <?//php echo $data['company_description']; ?></p>
                            </div>
                        </td> -->
                        <td>
                            <div class="box">
                                <!-- <p class="text-secondary fw-bold">E-Mail</p> -->
                                <?php echo $data['hr_rm_name']; ?>
                            </div>
                        </td>
                        <td>
                            <div class="box">
                                <!-- <p class="text-secondary fw-bold">Contact</p> -->
                                <p class=""><?php echo $data['hr_rm_contact_number']; ?></p>
                        ...
                        <!-- <td>
                            <div class="box">
                                <p class=""><?//php echo $data['previous_collaboration']; ?></p>
                            </div>
                        </td> -->
                        ...
                        <td>
                            <div class="box">
                                <!-- <p class="text-secondary fw-bold">Contact</p> -->
                                <p class=""><?php echo $data['testimonials']; ?></p>

                            </div>
                        </td>


                        <!-- <td><?//php echo $data['collaboration_opportunities']; ?></td>
                        <td><?//php echo $data['industry_relevant_projects']; ?></td>
                        <td><?//php echo $data['internships_coop_opportunities']; ?></td>
                        <td><?//php echo $data['job_placement_recruitment']; ?></td> -->
