...
<head>
    <title>companies-students</title>
    <!-- Required meta tags -->
    <meta charset="utf-8" />
...
<body>
    <main>
        ...
        $sqlSelect = "SELECT * FROM companies_students";
            ...
            ?>
                    <tr>
                        ...
                        <td>
                            <div class="box">
                                <p class=" fw-bold">
                                    <?php echo $data['current_course']; ?></p>
                            </div>
                        </td>
                        <td>
                            <div class="box">
                                <!-- <p class="text-secondary fw-bold">E-Mail</p> -->
                                <?php echo $data['communication_languages']; ?>
                            </div>
                        </td>
                        <td>
                            <div class="box">
                        ...
                        <td>
                            <div class="box">
                                <!-- <p class="text-secondary fw-bold">Contact</p> -->
                                <p class=""><?php echo $data['academic_performance']; ?></p>
                        ...
                        <!-- <td>
                            <div class="box">
                                <?//php echo $data['extracurricular_activities']; ?>
                            </div>
                        </td> -->

                        <!-- <td>
                            <div class="box">
                                <p class=""><?//php echo $data['work_experience']; ?></p>
                            </div>
                        </td> -->

                        <!-- <td>
                            <div class="box">
                                <p class=""><?//php echo $data['projects']; ?></p>
                            </div>
                        </td> -->
                        ...
                        <td>
                            <div class="box">
                                <!-- <p class="text-secondary fw-bold">Contact</p> -->
                                <p class=""><?php echo $data['skills']; ?></p>
