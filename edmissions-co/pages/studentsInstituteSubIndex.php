...
<head>
    ...
    <title>EDMISSIONS.APP - For Students</title>
...
<body>
    ...
    <div class="mt-5 section1">
        <div class="container-fluid">
            <div class="row">
                <div class="col">
                    <h1 class="m-0">Welcome to <br><span id="title">ED<span
                                class="missions-title">MISSIONS</span>.APP</span></h1>
                    <!-- <h4>Made Finding Easy!</h4> -->
                    <h4>Connect, Collaborate and Succeed.</h4>
                    <h4><em>For Students!</em></h4>
    ...
    <div class="container-fluid mainbox p-0 m-4">
        <h5 class="mt-5 mb-4 mr-2 ml-2">Please choose the type of Institution you are looking for <i
                class="fas fa-arrow-down fa-sm fa-fw"></i></h5>
        <div class="row flex-sm-col flex-md-row button-div">
            <!-- <div class="col-lg-3 col-md-4 col-sm-12 m-3"> -->

            <div class="col buttons" style="width:fit-content;">
                <a href="students-schools.php">
                    ...
                    <button style="position:relative;" class="cta-buttons cta1">
                        <center><i style="color:#ffcc00;margin:10px;" class="fas fa-children fa-xs fa-fw"></i><br>
                            Schools
            ...
            <!-- <div class="col-lg-3 col-md-4 col-sm-12 m-3"> -->
            <div class="col buttons mt-0" style="width:fit-content;">
                <a href="students-intermediate.php">
                    ...
                    <button style="position:relative;" class="cta-buttons cta2">
                        <center> <i style="color:rgb(53, 75, 122);margin:10px;"
                                class="fas fa-address-card fa-xs fa-fw"></i><br>Intermediate</center> <i
                            style="position:absolute; bottom:25px; right:15px"
                            class="fas fa-arrow-circle-right fa-xs fa-fw"></i>
                    </button>
                </a>
            </div>
            ...
            <div class="col buttons" style="width:fit-content;">
                <a href="students-institutions.php">
                    <!-- <button class="cta-buttons cta1"><span>EDMISSIONS.APP for</span><br><i   style="color:rgb(53, 75, 122)" class="fas fa-children fa-xs fa-fw"></i> Students
                        </button> -->
                    <button style="position:relative;" class="cta-buttons cta3">
                        <center><i style="color:rgb(53, 75, 122);margin:10px;"
                                class="fas fa-children fa-xs fa-fw"></i><br>Colleges
                        </center><i style="position:absolute; bottom:25px; right:15px"
                            class="fas fa-arrow-circle-right fa-xs fa-fw"></i>
                    </button>
                </a>
