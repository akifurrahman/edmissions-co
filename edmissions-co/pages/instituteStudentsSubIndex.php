...
<head>
    ...
    <title>EDMISSIONS.APP - For Institutes</title>
...
<body>
    ...
    <div class="container-fluid mainbox p-0 m-4">
        <h5 class="mt-5 mb-4 mr-2 ml-2">Please choose the type of Students you are looking for <i
        ...
        <div class="row flex-sm-col flex-md-row button-div">
            ...
            <div class="col buttons" style="width:fit-content;">
                <a href="institution-schoolStudents.php">
            ...
            <div class="col buttons mt-0" style="width:fit-content;">
                <a href="institution-intermediateStudents.php">
